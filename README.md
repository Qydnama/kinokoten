...
Бот учитывает только выбранные кинотеатры и не присылает повторные уведомления
об одних и тех же сеансах. Перед уведомлением он открывает данные плана зала:
одного появления сеанса в расписании недостаточно — продажа должна быть открыта
и в зале должно оставаться хотя бы одно свободное место.
...
- отличать опубликованное расписание от реально открытой продажи билетов;
